...
var robotPirat = function Constructor(settings){
    ...
    this.newChannel = function(message){
        var msg = "Bip bip!, ny flaskepost fra robot-piraten!\n"
        msg += "Der er lige blevet oprettet en <#" message.channel.id + "|" + message.channel.name;
        msg += "> tråd.\n Kig forbi hvis du synes det lyder spændende!";
        this.postMessageToChannel("pirat-robotten", msg, {as_user: true});
    }
